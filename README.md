![](https://img.shields.io/badge/Jupyter-Kernel-green?link=https://jupyter.org/&link=https://github.com/jupyter/jupyter/wiki/Jupyter-kernels) ![](https://img.shields.io/badge/MyGo-Kernel-orange) ![](https://img.shields.io/github/watchers/nufeng1999/jupyter-MyGo-kernel) <img alt="ViewCount" src="https://views.whatilearened.today/views/github/nufeng1999/jupyter-MyGo-kernel.svg">
    <a href="https://github.com/nufeng1999/jupyter-MyGo-kernel"><img alt="GitHub Clones" src="https://img.shields.io/badge/dynamic/json?color=success&label=Clone&query=count&url=https://raw.githubusercontent.com/nufeng1999/jupyter-MyGo-kernel/master/clone.json&logo=github"></a>
# MyGo kernel for Jupyter  
[Example](https://github.com/nufeng1999/jupyter-MyGo-kernel/blob/master/example/MyGo.ipynb "Example")
...
### Step-by-step
```bash
git clone https://github.com/nufeng1999/jupyter-MyGo-kernel.git
cd jupyter-MyGo-kernel
pip install -e . 
cd jupyter_MyGo_kernel && python3 install_MyGo_kernel --user
